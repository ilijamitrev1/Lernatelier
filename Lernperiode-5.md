...
- [X] Tutorial finden, um jemandem folgen zu können und um Erklärung zu bekommen

Heute habe ich entschieden, dass ich eine App programmieren möchte. Ich habe zuerst mich informiert, welche Sprache ich benutzen muss und welche Umgebung überhaupt. Nach der Recherche habe ich mich entschieden, Visual Studio zu benutzen mit der c# Windows Form. Ich habe heute ein bisschen ausprobiert und ab nächstes Mal fange ich dann an dem Tutorial zu folgen. Falls das Tutorial dann nicht klappt, finde ich dann einen anderen Tutorial.
